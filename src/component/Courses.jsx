            ...
            <div className="row align-item-center">
                <div className="col-md-6">
                    <div className="home-header-text-holder pe-md-5">
                       ...
                       <div className="col-md-10 my-3 courses-search-form">
                ...
                <div className="col-md-6">
                    <div className="home-header-image-holder ">
                        <img  className="img-fluid rounded  shadow-sm full-width h-25" src="https://i.pinimg.com/564x/8a/94/b7/8a94b72a5639875e70d304571de5dc24.jpg" alt="" />
                    </div>
                </div>
            </div>
        </div>
...
<section>
        <div className="courses-list py-5">
        <div className="container">
            <div className="row">
