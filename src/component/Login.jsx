    ...
    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
     ...
     <main className='login '>
        <section className='  py-md-5 py-3 mt-5'>
            ...
            <div className='   border border-white shadow-lg p-3 mb-5 bg-body-tertiary rounded '>
            <h1 className="text-primary text-md-1 text-6 fw-normal text-center mb-2">Login in to your account</h1>
            <div className="d-flex flex-column flex-md-row justify-content-between gap-3 mb-3 align-items-center " >
             <p className='smedia border border-white p-3 d-flex justify-content-center align-items-center gap-3'>
             ...
             <p className='smedia border border-white  d-flex justify-content-center align-items-center gap-3 px-3'> 
            ...
            <div className="d-flex flex-column flex-md-row  mb-5 gap-3 px-3 position-relative">
                <input className=' border border-white mb-2  p-2 rounded-md shadow  bg-body-white rounded w-100' type='email' placeholder='Email Address'/>
                
                <input className='border border-white mb-2  p-2 rounded-md shadow  bg-body-white rounded w-100 ' type='password' placeholder='Password'/>
                  <p  onClick={handleMyeye} className='position-absolute end-0 bottom-0  pe-4'> 
            {
            ...
            <p className='text-6 fw-normal text-center px-3'> By clicking “Sign in”, you agree to our Term of Use and our Privacy Policy </p>
            <div className="d-flex  justify-content-center">
           <button type='button' className='btn btn-outline-primary bg-primary text-white  fw-bold p-3 rounded-md my-5' id='login-btn'>Sign in</button>
            </div>
            <p className='fs-6 fw-normal text-center'> Forget your password ?</p>
              <div className="d-flex align-items-center justify-content-center mt-5">
              <p className='d-flex align-items-center gap-3 text-center  fs-6 '> Don't have an account? 
              <Link to='/signup' className='text-[#3C0644] fw-semibold ' >Sign Up</Link>
              </p>
