...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
    ...
    <section className="faq-header py-5 border-bottom mt-5">
        <div className="container">
            <div className="row gx-md-5 align-items-center">
                ...
                <div className="breadcrumb-holder">
                  ...
                  <div className="single-current-holder pe-md-5 mb-3">
                    ...
                    <div className="col-md-10 my-3 faq-search-form">
    ...
    <section className="faq-list py-5">
        <div className="container">
            <div className="row">
                <div className="col-md-8">
                    <details className="card text-bg-light small mb-3 ">
                        <summary className="card-header">
                            Lorem, ipsum dolor sit amet
                        </summary>
                        <div className="card-body">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis dicta corporis est nesciunt nulla labore quo, voluptate eius repellendus cupiditate optio earum ad ipsa, aliquid corrupti. Excepturi, ad. Exercitationem, recusandae.</p>
                        </div>
                    </details>
                    <details className="card text-bg-light small mb-3 ">
                        <summary className="card-header">
                    ...
                    </details><details className="card text-bg-light small mb-3 ">
                        <summary className="card-header">
                            Lorem, ipsum dolor sit amet
                        </summary>
                        <div className="card-body">
                ...
                <div className="col-md-4">
                    <div className="card mb-4">
                        <div className="card-header text-bg-primary justify-content-center">Post your Questions</div>
                        <div className="card-body">
                            <form>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="mb-2">
                                            <input type="text"  className="form-control form-control-sm" placeholder="Name" required />
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-2">
                                            <input type="text"  className="form-control form-control-sm" placeholder="Your Question title" required />
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-2">
                                           <textarea  rows="5" className="form-control form-control-sm"  placeholder="Your Question in detail"></textarea>
