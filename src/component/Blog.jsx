...
function Blog() {
     const postList= [
        ...
        cate:"Tech",
        name:"Augustine",
        content:"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique, iste tempore cum quis aut temporibus ipsa! Animi neque exercitationem, dicta voluptatum illo"
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
   ...
   <section className="blog-header py-5 mt-5 border-bottom gx-md-5 mt-5">
    <div className="container">
        <div className="row align-item-center">
            <div className="col-md-6">
                <div className="blog-header-text-holder pe-md-5">
                    ...
                    <a 
                    href="#"
                     className="btn btn-sm  btn-success mt-2 mb-3 d-inline-flex align-item-center justify-content-center"
                     data-bs-toggle="modal"
                     data-bs-target="#subscribe_modal">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope-at-fill me-2" viewBox="0 0 16 16">
    ...
    <section className="blog-post-list py-5 border-bottom">
    <div className="container">
        <div className="row">
            <div className="col-md-9">
                <div className="list-group small">
                    <div className="list-group-item text-bg-light fw-bold d-flex justify-content-between align-items-center">
                       ...
                       <span className="badge text-bg-warning rounded-pill">24 posts</span>
                        
                    </div>
                      {
                        postList.map(post=>(
                            <Link to={`/SingleBlog/${post.id}`} className='list-group-item list-group-item-action mb-3' key={post.id}>
                                <div className="row align-items-center g-3 ">
                            <div className="col-md-3 col-lg-4">
                               <div className="course-image-holder">
                                <img className="rounded img-fluid mb-md-0 mt-md-0 mt-2" src={post.img} alt="" />
                            ...
                            <div className="col-md-9 col-lg-8 ">
                              ...
                              <span className="badge text-bg-dark rounded-pill me-2">
                                <strong>Category</strong>
                                  <span className="fw-light"> {post.cate}</span>
                               </span>
                               <span className="badge text-bg-dark rounded-pill me-2">
                                <strong>Author:</strong>
                                  <span className="fw-light">{post.name}</span>
                               </span>
                                </p>
                            </div>
